...
| [THE_TIMDR_Hyperflow_Engine](https://github.com/jbackk-lang/THE_TIMDR_Hyperflow_Engine) | TIMDR Hyperflow Engine — koncepcyjna pętla percepcyjna (strumień/topologia/przepływ/stabilność) |
...
Pełny podział na narzędzia inżynierskie (zweryfikowany, działający kod) i modele koncepcyjne (warstwa metaforyczna) — patrz [`KATEGORIE.md`](KATEGORIE.md).
